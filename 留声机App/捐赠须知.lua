...
对话框()
  ...
  .设置中立按钮("联系客服",function()
    ...
    对话框()--框中框开始♥♥♥
    .设置标题("联系客服须知")
    .设置消息("❶联系前请先检查你的网易云音乐云盘内是否已经上传李志音乐。\n❷联系时请〔详细说明你的问题〕并附上〔捐赠截图〕，客服会在7天内回复。请珍惜时间，有事直奔主题、高效提问，〔你好,在吗〕这类废话一律不回。\n❸对于忘记填写账号密码，或提供的账号密码无法登陆这类情况，只给一次重新传歌的机会。请在把新密码发给客服前自行验证是否能登录，否则后果自负。\n❹正常情况下会在1周内重新传歌，这段时间内如无要事请勿催勿扰！！\n\n阅读完成后请点击下方按钮，去网易云音乐App私信【推歌君】")
    .设置积极按钮("联系推歌君",function()
